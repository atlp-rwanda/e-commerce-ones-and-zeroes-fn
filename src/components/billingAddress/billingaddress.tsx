...
const BillingAddress: React.FC = () => {
  ...
  const { address, loading, error, isSuccess } = useSelector(
  ...
  return (
    <div className="billing">
      <div className="billing-address">
        ...
        {address?(<div className="billing-details">
            ...
            <table>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div>
                      {address ? address.province : "....No Data......"}
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div>
                      {address ? address.district : "....No Data......"}
                    </div>
                  </td>
                </tr>
                <tr>
          ...
          <div style={{textAlign:"center"}}>No address found,<br /> use create button to add your address</div>
        )}
